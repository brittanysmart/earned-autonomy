    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            // Popover surface instead of shadcn's inverted default: a near-white
            // tooltip is jarring on the dark brand surfaces. No arrow for the
            // same reason — quieter, and the border does the anchoring work.
